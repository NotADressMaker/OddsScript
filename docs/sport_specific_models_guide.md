...
12. `spread_rating_interaction` - Rating differential * spread
13. `rest_home_interaction` - Rest advantage * home court
14. `pace_rating_interaction` - Pace differential * rating differential
15. `four_factors_recent_interaction` - Four factors diff * recent net rating diff
